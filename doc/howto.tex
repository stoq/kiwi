...
All you need to use Kiwi is Python and PyGTK. Additionally Gazpacho is 
strongly recommended. It's free software licensed under the LGPL and can 
be used and embedded in any application.
\end{abstract}
