...
bug reports, so you can be sure your application can rely on a library that 
is actively supported and that its authors has a continued interest 
in maintaining.
...
\citetitle[http://www.freshmeat.net/]{Freshmeat} and \code{python-announce}.
